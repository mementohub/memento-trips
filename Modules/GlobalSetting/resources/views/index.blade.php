                                                                        ...
                                                                        <div class="crancy__item-group">
                                                                            ...
                                                                            <div class="crancy__item-form--group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <br>
                                                                                    <div class="crancy__item-group mg-top-40">
    <h3 class="crancy__item-group__title">Date firmă (Billed From)</h3>
    <div class="crancy__item-form--group">
        <div class="row">

            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    <label class="crancy__item-label">Company</label>
                    <input class="crancy__item-input" type="text" name="invoice_company_name" value="{{ $general_setting->invoice_company_name ?? '' }}">
                </div>
            </div>
            ...
            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    ...
                    <input class="crancy__item-input" type="text" name="invoice_company_email" value="{{ $general_setting->invoice_company_email ?? '' }}">
                </div>
            </div>
            ...
            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    ...
                    <input class="crancy__item-input" type="text" name="invoice_company_phone" value="{{ $general_setting->invoice_company_phone ?? '' }}">
                </div>
            </div>

            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    <label class="crancy__item-label">VAT ID</label>
                    <input class="crancy__item-input" type="text" name="invoice_company_vat_id" value="{{ $general_setting->invoice_company_vat_id ?? '' }}">
                </div>
            </div>

            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    <label class="crancy__item-label">Registration No.</label>
                    <input class="crancy__item-input" type="text" name="invoice_company_reg_no" value="{{ $general_setting->invoice_company_reg_no ?? '' }}">
                </div>
            </div>

            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    <label class="crancy__item-label">EORI</label>
                    <input class="crancy__item-input" type="text" name="invoice_company_eori" value="{{ $general_setting->invoice_company_eori ?? '' }}">
                </div>
            </div>

            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    <label class="crancy__item-label">IBAN</label>
                    <input class="crancy__item-input" type="text" name="invoice_company_iban" value="{{ $general_setting->invoice_company_iban ?? '' }}">
                </div>
            </div>

            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    <label class="crancy__item-label">Bank</label>
                    <input class="crancy__item-input" type="text" name="invoice_company_bank_name" value="{{ $general_setting->invoice_company_bank_name ?? '' }}">
                </div>
            </div>

            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    <label class="crancy__item-label">Address line 1</label>
                    <input class="crancy__item-input" type="text" name="invoice_company_address_line1" value="{{ $general_setting->invoice_company_address_line1 ?? '' }}">
                </div>
            </div>
            ...
            <div class="col-md-6 col-12">
                <div class="crancy__item-form--group mg-top-form-20">
                    ...
                    <input class="crancy__item-input" type="text" name="invoice_company_address_line2" value="{{ $general_setting->invoice_company_address_line2 ?? '' }}">
                </div>
            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="crancy-ptabs__separate">
                                                                    <div class="crancy-ptabs__form-main">
                                                                        <div class="crancy__item-group">
                                                                            <h3 class="crancy__item-group__title">{{ __('Google Analytics') }}</h3>
                                                                            <div class="crancy__item-form--group">
                                                                                <div class="row">
                                                                                    <div class="col-12">
                                                                                        <div class="crancy__item-form--group mg-top-form-20">
