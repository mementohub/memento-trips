...
<style>
    ...
    .tg-tour-about-tickets-wrap { display: block !important; }
    ...
    @media (max-width: 991px) {
        /* Hide sidebar booking on mobile */
        .tg-tour-about-sidebar { display: none !important; }

        /* Sticky button — sits above bottom bar */
        .mob-book-sticky {
            display: block;
            position: fixed;
            left: 0; right: 0;
        ...
        /* Make form elements fit nicely inside the sheet */
