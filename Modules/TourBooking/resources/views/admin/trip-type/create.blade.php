...
@section('title')
    <title>{{ __('translate.Create Trip Type') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Create Trip Type') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Tour Booking') }} >> {{ __('translate.Create Trip Type') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.tourbooking.trip-type.store') }}" method="POST"
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">
                                                    {{ __('translate.Create Trip Type') }}</h4>
                                            ...
                                            <button class="crancy-btn mg-top-25"
                                                type="submit">{{ __('translate.Create') }}</button>
