                                ...
                                <div class="col-lg-3 col-md-2 col-12 crancy-personals__list">
                                    <div class="crancy-psidebar">
                                        ...
                                        <div class="list-group crancy-psidebar__list" id="list-tab" role="tablist">
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id9" role="tab" aria-selected="false">
...
<div class="tab-pane fade" id="id9" role="tabpanel">
    <form action="{{ route('admin.update-payu') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-12">
                <div class="crancy-ptabs__separate">
                    <div class="crancy-ptabs__form-main">
                        <div class="crancy__item-group">
                            <h3 class="crancy__item-group__title">PayU Configuration</h3>
                            <div class="crancy__item-form--group">
                                <div class="row">

                                    <div class="col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            <label class="crancy__item-label">Visibility Status</label>
                                            <div class="crancy-ptabs__notify-switch crancy-ptabs__notify-switch--two">
                                                <label class="crancy__item-switch">
                                                    <input {{ $payment_setting->payu_status == 1 ? 'checked' : '' }} name="status" type="checkbox">
                                                    <span class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="crancy__item-form--group w-100 h-100">
                                                    <label class="crancy__item-label">Image</label>
                                                    <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                        <input type="file" class="btn-check" name="image" id="input-img-payu" autocomplete="off" onchange="payuPreviewImage(event)">
                                                        <label class="crancy-image-video-upload__label" for="input-img-payu">
                                                            <img id="view_payu_img" src="{{ asset($payment_setting->payu_image ?? 'uploads/default/payu.png') }}">
                                    ...
                                    <div class="col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            <label class="crancy__item-label">Currency *</label>
                                            <select class="form-select crancy__item-input" name="currency_id">
                                                <option value="">Select</option>
                                                @foreach ($currency_list as $currency)
                                                    <option {{ $payment_setting->payu_currency_id == $currency->id ? 'selected' : '' }} value="{{ $currency->id }}">
                                    ...
                                    <div class="col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            <label class="crancy__item-label">Merchant POS ID *</label>
                                            <input class="crancy__item-input" type="text" name="merchant_pos_id" value="{{ $payment_setting->payu_merchant_pos_id }}">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            <label class="crancy__item-label">Secret Key *</label>
                                            <input class="crancy__item-input" type="text" name="secret_key" value="{{ $payment_setting->payu_secret_key }}">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            <label class="crancy__item-label">Client ID *</label>
                                            <input class="crancy__item-input" type="text" name="client_id" value="{{ $payment_setting->payu_client_id }}">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            <label class="crancy__item-label">Client Secret *</label>
                                            <input class="crancy__item-input" type="text" name="client_secret" value="{{ $payment_setting->payu_client_secret }}">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="crancy__item-form--group mg-top-form-20">
                                            <label class="crancy__item-label">Sandbox Mode</label>
                                            <div class="crancy-ptabs__notify-switch crancy-ptabs__notify-switch--two">
                                                <label class="crancy__item-switch">
                                                    <input {{ $payment_setting->payu_sandbox == 1 ? 'checked' : '' }} name="sandbox" type="checkbox">
                                                    <span class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                </label>
                                            </div>
                                        </div>
