 ...
 *
 * Manages support ticket lifecycle — creation, messaging, status updates, and file attachments.
 *
 * @package Modules\SupportTicket\App\Http\Controllers\Support\Seller
 */
